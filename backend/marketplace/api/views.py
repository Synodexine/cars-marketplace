...
class AdvertisementRetrieveDestroyView(RetrieveDestroyAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.user.is_staff or self.queryset.filter(
            id=self.kwargs["pk"], owner=request.user
        ):
            return super(AdvertisementRetrieveDestroyView, self).get(
                request, *args, **kwargs
            )
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        if request.user.is_staff or self.queryset.filter(
            ...
            return super(AdvertisementRetrieveDestroyView, self).destroy(
                request, *args, **kwargs
            )
        raise PermissionDenied()
